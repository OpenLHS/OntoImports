 ...
 * [OntoImports.yml](OntoImports.yml)
     * Determines how your purl.obolibrary.org/obo/OntoImports/ redirects will be handled
     ...
     * Paste in the contents of [OntoImports.yml](OntoImports.yml)
 ...
 * [OntoImports.md](OntoImports.md)
     ...
     * Paste in the contents of [OntoImports.md](OntoImports.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
